<ul id="menu">
  ...
  <!-- ARIEL DIFF DB-->
  <li id="catalog_per_storage"><a class="parent"><i class="fa fa-info-circle fa-fw"></i> <span>Каталог по обекти</span></a>
    <ul>
      <li><a href="<?php echo $products_per_storage; ?>">Продукти - количества по обекти</a></li>     
    </ul>
  </li>
