      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            ...
            <?php if( $loggedin_user_group == 1 ) { ?>
            <div class="col-sm-3">
              <div class="form-group">
                <label class="control-label" for="input-dealer">ДИЛЪР</label>
                <select name="filter_dealer" id="input-dealer" class="form-control">
                  <option value="">Всички клиенти</option>
                  <option value="*" <?php if ( $filter_dealer == '*' ) { echo 'selected'; }?>>Без дилър</option>
                  <?php foreach ($dealers as $dealer) { ?>
                  <?php if ($dealer['user_id'] == $filter_dealer) { ?>
                  <option value="<?php echo $dealer['user_id']; ?>" selected="selected"><?php echo $dealer['name']; ?></option>
                  <?php } else { ?>
                  <option value="<?php echo $dealer['user_id']; ?>"><?php echo $dealer['name']; ?></option>
                  <?php } ?>
                  <?php } ?>
                </select>
              </div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'customer_group') { ?>
                    ...
                    <?php } ?></td>
                  <?php if( $loggedin_user_group == 1 ) { ?>
                  <td class="text-left"><?php if ($sort == 'dealer_id') { ?>
                    <a href="<?php echo $sort_dealer; ?>" class="<?php echo strtolower($order); ?>">Дилър</a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_dealer; ?>">Дилър</a>
                    <?php } ?></td>
                  <?php } ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <?php if( $loggedin_user_group == 1 ) { ?>
                  <td class="text-left"><?= $customer['dealer']?></td>
                  <?php } ?>
                  ...
                  <td class="text-right"><?php if ($customer['approve']) { ?>
                    ...
                    <div class="btn-group" data-toggle="tooltip" title="<?php echo $button_login; ?>">
                      ...
                      <ul class="dropdown-menu pull-right">
                        <!-- ARIEL IS DEALER AND MULTI STORAGE-->
                        <?php foreach ($storages as $storage) {
                        ?>
                       <li><a href="index.php?route=customer/customer/login&token=<?php echo $token; ?>&customer_id=<?php echo $customer['customer_id']; ?>&store_id=0&is_dealer=1&storage=<?= $storage['storage_id']?>" target="_blank"><?php echo $text_default; ?> - <?= $storage['name'] ?></a></li>                     
                        <?php
                          }
                        ?>                       
                      </ul>
...
$('#button-filter').on('click', function() {
	...
	var filter_dealer = $('select[name=\'filter_dealer\']').val();
  
  if (filter_dealer) {
    url += '&filter_dealer=' + encodeURIComponent(filter_dealer);
  }
  ...
  // // ARIEL
  // var filter_customer_role_id = $('select[name=\'filter_customer_role_id\']').val();
  
  // if (filter_customer_role_id != '*') {
  //   url += '&filter_customer_role_id=' + encodeURIComponent(filter_customer_role_id);
  // } 
  // // ARIEL END
