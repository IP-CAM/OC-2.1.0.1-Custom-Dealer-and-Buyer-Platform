      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-discounts" data-toggle="tab"><?php echo 'отстъпки по категории'; ?></a></li>
            <li><a href="#tab-discounts-products" data-toggle="tab"><?php echo 'отстъпки по продукти'; ?></a></li>
            <!-- ARIEL SUB EMAILS -->
            <li><a href="#tab-subemails" data-toggle="tab"><?php echo 'Допълнителни EMAIL-и'; ?></a></li>
            <!-- ARIEL END -->  
          ...
          <div class="tab-content">
            ...
            <!-- ARIEL SUB EMAIL -->
            <div class="tab-pane" id="tab-subemails">
              <div class="row">
                <div class="col-sm-6">
                  <?php $customer_subemail_row = 1 ?>
                  <table id="subemails" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        <td class="text-center">допълнителен EMAIL</td>     
                        <td></td>           
                      </tr>
                    </thead>
                    <tbody>
                      <?php if( !empty( $customer_subemails ) ) { ?>                
                        <?php foreach( $customer_subemails as $cse ) { ?>                
                        <!-- if subemails FOREACH subemail -->
                        <tr id="subemail-row-<?= $customer_subemail_row ?>">
                          <td class="text-right"><input type="hidden" name="customer_subemails[<?= $customer_subemail_row ?>][subemail]" value="<?= $cse['subemail'] ?>"/>  
                            <?= $cse['subemail'] ?>
                          </td>                 
                          <!-- REMOVE -->
                          <td class="text-center"><button type="button" onclick="$('#subemail-row-<?= $customer_subemail_row ?>').remove();" data-toggle="tooltip" title="Премахни email" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                            <?php $customer_subemail_row++ ?>
                        </tr>
                        <?php } ?>
                      <?php } ?>
                      <!-- end if and foreach -->             
                    ...
                    <tfoot>
                      <tr>
                        <td colspan=""></td>
                        <td class="text-center"><button type="button" id="add-customer-subemail"  data-toggle="tooltip" title="Добави email" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                      </tr>
                    </tfoot>
                  </table>
                </div>
...
<?php } ?>
// ARIEL SUBEMAILS
    var customer_subemail_row = <?php echo $customer_subemail_row; ?>;
    console.log(customer_subemail_row);

    $('#add-customer-subemail').on('click', function(){
      
      html = "<tr id='subemail-row-"+customer_subemail_row+"'>";
      html +="<td class='text-right'><input type='text' class='form-control' name='customer_subemails["+customer_subemail_row+"][subemail]'/></td>";
      html += "<td class='text-center'><button type='button' onclick=$('#subemail-row-"+customer_subemail_row+"').remove(); data-toggle='tooltip' title='Премахни email' class='btn btn-danger'><i class='fa fa-minus-circle'></i></button></td></tr>";
      customer_subemail_row++;
     
      $('#subemails tbody').append(html); 
    });
