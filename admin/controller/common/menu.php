...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		// ARIEL DB 
		$data['products_per_storage'] = $this->url->link('catalog_per_storage/product_per_storage', 'token=' . $this->session->data['token'], 'SSL');
		//ARIEL END
		...
		// ARIEL MULTISTORAGES
		$data['storages'] = $this->url->link('storages/storages', 'token=' . $this->session->data['token'], 'SSL');
