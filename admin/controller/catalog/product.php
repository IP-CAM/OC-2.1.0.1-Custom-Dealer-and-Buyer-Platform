...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		// // ARIEL SF DB PRODUCTS DATA
		// $results_sf = $this->model_catalog_product->getSfProducts($filter_data);
		// var_dump($results_sf[0]['product_id'], $results_sf[0]['quantity']);

		// foreach ($results_sf as $result) {			

		// 	$data['products_sf'][] = array(
		// 		'product_id' => $result['product_id'],				
		// 		'name'       => $result['name'],
		// 		'model'      => $result['model'],				
		// 		'quantity'   => $result['quantity']			
		...
		// $results_dobr = $this->model_catalog_product->getDobrProducts($filter_data);
		// var_dump($results_dobr[0]['product_id'], $results_dobr[0]['quantity'] );
		// die;

		// foreach ($results_dobr as $result) {

		// 	$data['products_dobr'][] = array(
		// 		'product_id' => $result['product_id'],				
		// 		'name'       => $result['name'],
		// 		'model'      => $result['model'],				
		// 		'quantity'   => $result['quantity']			
