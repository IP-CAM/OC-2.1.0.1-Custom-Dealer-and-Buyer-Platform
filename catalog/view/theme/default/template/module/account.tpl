<div class="list-group">
  ...
  <?php if ($logged) { ?>
  <?php if( $customer_role['customer_role_id'] == 2 ) { ?>
        <a href="<?= $order_in_detail; ?>"  class="list-group-item">Поръчки - подробно</a>
        <?php } elseif( $customer_role['customer_role_id'] == 1 ) { ?>
        <a href="<?= $order_in_detail; ?>"  class="list-group-item">Поръчки - Повторение и детайли</a> 
  <?php } ?> 
