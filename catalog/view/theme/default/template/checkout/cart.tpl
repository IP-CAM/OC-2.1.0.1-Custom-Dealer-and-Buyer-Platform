          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <?php if( $is_dealer == 1 ) { ?>
                  <td class="text-right">
                    <input type="text" name="dealer_price[<?php echo $product['cart_id']; ?>]" value="<?php echo $product['dealer_price']; ?>" size="1" class="form-control" />
                  </td>
                <?php } ?>
              <?php } else { ?>
                <td class="text-right"><?php echo $product['price']; ?></td>
                <input type="hidden" name="dealer_price[<?php echo $product['cart_id']; ?>]" value="<?php echo $product['dealer_price']; ?>" />
