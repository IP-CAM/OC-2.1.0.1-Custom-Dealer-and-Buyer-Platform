...
class ModelAccountCustomer extends Model {
	...
	// ARIEL SUBEMAILS
	public function getCustomerSubemails() {
		
		$subemail_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "customer_subemails WHERE customer_id = '" . (int)$this->customer->getId() . "'");

		return $subemail_query->rows;	
	}

	public function getCustomerEmail() {
		
		$subemail_query = $this->db->query("SELECT email FROM " . DB_PREFIX . "customer WHERE customer_id = '" . (int)$this->customer->getId() . "'");

		return $subemail_query->row;	
	}
	// ARIEL
}
