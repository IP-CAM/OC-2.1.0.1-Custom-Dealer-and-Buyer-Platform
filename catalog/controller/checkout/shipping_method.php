...
class ControllerCheckoutShippingMethod extends Controller {
	public function index() {
		...
		$data['text_delivery_day'] = $this->language->get('text_delivery_day');
		...
		var_dump($this->session->data['delivery_day']);
	...
	public function save() {
		...
		if (!$json) {
			...
			$this->session->data['delivery_day'] = strip_tags($this->request->post['delivery_day']);
		}
