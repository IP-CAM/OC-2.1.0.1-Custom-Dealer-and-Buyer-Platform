...
class ControllerCheckoutPaymentAddress extends Controller {
	public function index() {
		...
		$data['default_email'] = $this->model_account_customer->getCustomerEmail();
		$data['subemails'] = $this->model_account_customer->getCustomerSubemails();
		...
		if (!$json) {
			if (isset($this->request->post['payment_address']) && $this->request->post['payment_address'] == 'existing') {
				...
				if (!$json) {
					...
					$this->session->data['subemail'] = $this->request->post['subemail'];
