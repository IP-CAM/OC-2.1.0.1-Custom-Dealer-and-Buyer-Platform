...
// Database sf
$sfdb = new DB(SFDB_DRIVER, SFDB_HOSTNAME, SFDB_USERNAME, SFDB_PASSWORD, SFDB_DATABASE, SFDB_PORT);
$registry->set('sfdb', $sfdb);

// Database dobr
$dobrdb = new DB(DOBRDB_DRIVER, DOBRDB_HOSTNAME, DOBRDB_USERNAME, DOBRDB_PASSWORD, DOBRDB_DATABASE, DOBRDB_PORT);
$registry->set('dobrdb', $dobrdb);
